        ...
        <section className="hero">
          <div className="hero-layout">
            <div className="hero-content">
              ...
              <h2>
                I build modern web apps with a focus on interaction, polish, and
                real functionality
              </h2>
              <p>
                I enjoy creating responsive websites, interactive user
                interfaces, and full-stack projects using React, Node.js,
          ...
          <div className="about-layout">
            <div className="about-text">
              ...
              <p>
                ...
                creating projects that combine clean design with real
                functionality, whether that means building responsive frontend
                layouts, working through full-stack features, or refining how an
                app feels to use.
              </p>
              <p>
                A lot of my work centers around React, JavaScript, Node.js, and
                MongoDB, with a strong interest in frontend interaction and
                overall project structure. I enjoy taking an idea from concept to
                a working product and improving both the technical side and the
        ...
        <section id="projects" className="section">
          <div className="section-heading">
            ...
            <p>
              ...
              reflect both my frontend focus and full-stack development
              experience.
            </p>
          </div>
        ...
        <section id="contact" className="section">
          <div className="contact-section">
            <div className="contact-text">
              <h2>Contact</h2>
              <p>
                I’m always open to new opportunities, projects, and
                collaborations. Feel free to reach out or connect with me through
                the links below.
              </p>
            </div>

            <div className="contact-grid">
              <a className="contact-card" href="mailto:ptniversn@gmail.com">
